...
\renewcommand{\maketitle} {
    ...
    \begin{minipage}[b]{.25\textwidth} % {
        \smash{\includegraphics[height=1.5in]{cv/head.jpg}}
	\end{minipage}
}
...
\newcommand{\ruijie}{\includegraphics[height=.85em]{cv/ruijie.png}}
\newcommand{\fzu}{\includegraphics[height=.85em]{cv/fzu.png}}
...
\entry{2016--2019}
	{硕士, Fuzhou University (\href{https://www.fzu.edu.cn}{福州大�??\fzu})}
	{fuzhou, China}
	{控制理�?�与控制工程 Major in Syntax; minor in \textbf{Romance Languages}. Thesis: \textit{External Possession and the Undisentanglability of Syntax and Semantics} \href{https://lukesmith.xyz/thesis.pdf}{\pdf}. Advisor: \vera.}

\entry{2012--2016}
    {�?�?, Fuzhou University (\href{https://www.fzu.edu.cn}{福州大�??\fzu})}
	{福州fuzhou, China}
	{电气工程与自动化专业}
